...
|-------------|-------------|
| `package.json` | base, typescript, python, react, nextjs, vue, nuxt, hono, fastapi, express, batch, cdk, bicep |
...
| `.github/workflows/ci.yaml` | base, typescript, python, hono, fastapi, express, batch, cdk, cloudformation, terraform, bicep |
